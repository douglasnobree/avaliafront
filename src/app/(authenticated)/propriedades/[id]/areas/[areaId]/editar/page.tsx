    ...
    try {
      ...
      if (tipo === 'SETOR_HIDRAULICO' && data.setor_hidraulico) {
        ...
        form.reset({
          ...
          data_ultima_manutencao: new Date(setor.data_ultima_manutencao)
            .toISOString()
            .split('T')[0],
        });
        ...
        form.reset({
          ...
          data_ultima_manutencao: new Date(pivo.data_ultima_manutencao)
            .toISOString()
            .split('T')[0],
          freq_manutencao: pivo.freq_manutencao,
          problemas_observados: pivo.problemas_observados || '',
          data_ultima_avaliacoes: new Date(pivo.data_ultima_avaliacoes)
            .toISOString()
            .split('T')[0],
        });
      }
